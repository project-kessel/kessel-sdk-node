...
function createBaseAcquireLockRequest(): AcquireLockRequest {
  return { lockId: "" };
}
...
export const AcquireLockRequest = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AcquireLockRequest {
    const reader =
      input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAcquireLockRequest();
  ...
  fromJSON(object: any): AcquireLockRequest {
    return {
      lockId: isSet(object.lockId) ? globalThis.String(object.lockId) : "",
    };
  },

  toJSON(message: AcquireLockRequest): unknown {
    const obj: any = {};
    if (message.lockId !== undefined && message.lockId !== "") {
  ...
  create<I extends Exact<DeepPartial<AcquireLockRequest>, I>>(
    base?: I,
  ): AcquireLockRequest {
    return AcquireLockRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AcquireLockRequest>, I>>(
    object: I,
  ): AcquireLockRequest {
    const message = createBaseAcquireLockRequest();
