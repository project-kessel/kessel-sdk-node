 ...
 */
export interface DeleteTuplesResponse {
  consistencyToken?: ConsistencyToken | undefined;
}

function createBaseDeleteTuplesResponse(): DeleteTuplesResponse {
  return { consistencyToken: undefined };
}

export const DeleteTuplesResponse = {
  encode(
  ...
  decode(
    ...
    const message = createBaseDeleteTuplesResponse();
  ...
  fromJSON(object: any): DeleteTuplesResponse {
    return {
  ...
  toJSON(message: DeleteTuplesResponse): unknown {
    const obj: any = {};
    if (message.consistencyToken !== undefined) {
  ...
  create<I extends Exact<DeepPartial<DeleteTuplesResponse>, I>>(
    base?: I,
  ): DeleteTuplesResponse {
    return DeleteTuplesResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DeleteTuplesResponse>, I>>(
    object: I,
  ): DeleteTuplesResponse {
    const message = createBaseDeleteTuplesResponse();
    message.consistencyToken =
