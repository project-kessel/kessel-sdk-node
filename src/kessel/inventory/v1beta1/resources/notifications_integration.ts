...
function createBaseNotificationsIntegration(): NotificationsIntegration {
...
export const NotificationsIntegration = {
  ...
  decode(
    ...
    const message = createBaseNotificationsIntegration();
  ...
  fromJSON(object: any): NotificationsIntegration {
    return {
  ...
  toJSON(message: NotificationsIntegration): unknown {
    const obj: any = {};
    if (message.metadata !== undefined) {
  ...
  create<I extends Exact<DeepPartial<NotificationsIntegration>, I>>(
    base?: I,
  ): NotificationsIntegration {
    return NotificationsIntegration.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NotificationsIntegration>, I>>(
    object: I,
  ): NotificationsIntegration {
    const message = createBaseNotificationsIntegration();
    message.metadata =
