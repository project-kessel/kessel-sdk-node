...
export interface KesselNotificationsIntegrationServiceImplementation<
  CallContextExt = {},
> {
  createNotificationsIntegration(
    request: CreateNotificationsIntegrationRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<CreateNotificationsIntegrationResponse>>;
  updateNotificationsIntegration(
    request: UpdateNotificationsIntegrationRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<UpdateNotificationsIntegrationResponse>>;
  /** deprecated Temporary streaming update endpoint */
  updateNotificationsIntegrations(
    request: AsyncIterable<UpdateNotificationsIntegrationsRequest>,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<UpdateNotificationsIntegrationsResponse>>;
  deleteNotificationsIntegration(
    request: DeleteNotificationsIntegrationRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<DeleteNotificationsIntegrationResponse>>;
  listNotificationsIntegrations(
    request: ListNotificationsIntegrationsRequest,
    context: CallContext & CallContextExt,
  ): ServerStreamingMethodResult<
    DeepPartial<ListNotificationsIntegrationsResponse>
  >;
}

export interface KesselNotificationsIntegrationServiceClient<
  CallOptionsExt = {},
> {
  createNotificationsIntegration(
    request: DeepPartial<CreateNotificationsIntegrationRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<CreateNotificationsIntegrationResponse>;
  updateNotificationsIntegration(
    request: DeepPartial<UpdateNotificationsIntegrationRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<UpdateNotificationsIntegrationResponse>;
  /** deprecated Temporary streaming update endpoint */
  updateNotificationsIntegrations(
    request: AsyncIterable<DeepPartial<UpdateNotificationsIntegrationsRequest>>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<UpdateNotificationsIntegrationsResponse>;
  deleteNotificationsIntegration(
    request: DeepPartial<DeleteNotificationsIntegrationRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<DeleteNotificationsIntegrationResponse>;
  listNotificationsIntegrations(
    request: DeepPartial<ListNotificationsIntegrationsRequest>,
    options?: CallOptions & CallOptionsExt,
  ): AsyncIterable<ListNotificationsIntegrationsResponse>;
}
