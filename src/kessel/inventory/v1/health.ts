...
export interface KesselInventoryHealthServiceImplementation<
  CallContextExt = {},
> {
  getLivez(
    request: GetLivezRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<GetLivezResponse>>;
  getReadyz(
    request: GetReadyzRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<GetReadyzResponse>>;
}

export interface KesselInventoryHealthServiceClient<CallOptionsExt = {}> {
  getLivez(
    request: DeepPartial<GetLivezRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<GetLivezResponse>;
  getReadyz(
    request: DeepPartial<GetReadyzRequest>,
    options?: CallOptions & CallOptionsExt,
