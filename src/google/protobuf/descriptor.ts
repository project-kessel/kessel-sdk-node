...
export interface ExtensionRangeOptions {
   ...
   * used externally.
   */
  declaration?: ExtensionRangeOptions_Declaration[] | undefined;
...
export interface FieldOptions {
  ...
  editionDefaults?: FieldOptions_EditionDefault[] | undefined;
  /**
   * Any features defined in the specific edition.
   * WARNING: This field should only be used by protobuf plugins or special
   * cases like the proto compiler. Other uses are discouraged and
...
export interface FeatureSetDefaults {
  defaults?: FeatureSetDefaults_FeatureSetEditionDefault[] | undefined;
  /**
...
export const ExtensionRangeOptions = {
  encode(
    ...
    if (message.verification !== undefined && message.verification !== 0) {
...
export const FieldOptions = {
  encode(
    ...
    if (
      message.editionDefaults !== undefined &&
      message.editionDefaults.length !== 0
    ) {
